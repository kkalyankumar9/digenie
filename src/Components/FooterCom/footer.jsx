    ...
    <div className="footerMain">
      <div className="footerCon">
        <div className="footer1">
          <div className="fc1">
            <img
              src="https://s3-alpha-sig.figma.com/img/bd36/41fc/799918723dbbd2a9d7a427545f44384e?Expires=1722211200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=A2W7LD9P9vNjTt25fNDj-fOMmou~9D-D0ogx4wM1p~geiy1DvsPQZtmbiawRcWBuf0LRydjOG0ii~DWykP~RH1~YQDlBDZ0VxJCl4fTsz6AFyuwGV-YB8Kl8Hm0z0NxH-4FI~GJpjdgOew-KUrEgOGu-hQLGLhJKFervnLn2j8oCZB7PEI69wFt98UJdqkBNbCAcoo8BLwLaqaPRFMGsj718gU8WJ~3yRVVUx6ajofRWwCAFiaoOVUgewH~AqSA5vgA02xljeK3E~81aBMzXSQDmJc~YU2P~LLMKlenRwy~6paZqRs3aBCSkaBWYueeeg-t3HIGVevsE~IaMpurBpQ__"
              alt=""
            />
            <p>Arasi Arts</p>
