...
const SectionCom4 = () => {
  ...
  <p>learn Tanjore Painting , Relief Art , Kerala Mural , fridge Magnet , single store painting , Knife Painting and various other techniques. Enroll in a class today </p>
</div>
<div class="sec5image">
{
    data?.map((e,i)=>(
